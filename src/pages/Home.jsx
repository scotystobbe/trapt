...
import { FaCompass, FaSpotify, FaApple } from 'react-icons/fa';
  ...
  return (
    <div style={{ backgroundColor: '#18181b' }} className="min-h-screen">
      ...
      <div className="max-w-4xl mx-auto w-full p-4 flex flex-col items-center min-h-[70vh]">
        <div className={`grid grid-cols-1 ${isAdmin ? 'md:grid-cols-3' : 'md:grid-cols-2'} gap-8 w-full max-w-2xl mt-4`}>
