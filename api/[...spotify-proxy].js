...
module.exports = async (req, res) => {
  ...
  const proxyPath = parsedUrl.query.proxyPath || '';
  ...
  // 4. Playlist proxy: /api/spotify-proxy?playlistId=...
  if (req.method === 'GET' && parsedUrl.query.playlistId) {
    try {
      const playlistId = parsedUrl.query.playlistId;
